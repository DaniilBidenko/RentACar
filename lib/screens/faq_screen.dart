      ...
      body: ListView(
        children: [
          ...
          Column(
            ...
            children: [
              Padding(
                padding: EdgeInsets.only(top: width * 0.03, bottom: width * 0.02, left: width * 0.4),
                    ...
                    child: Row(
                      ...
                      children: [
                       Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          textFields('Пожалуйста введите Фамилию Имя Отчество', 'Биденко Даниил Викторович', 'Имя Фамалия Отчество', context, nameController),
             ...
             Padding(
              padding: EdgeInsets.only(left: width * 0.4, bottom: height * 0.03),
              child:  Column(
                children: [
            ...
            Container(
              decoration: BoxDecoration(
                border: Border(top: BorderSide(color: Color.fromRGBO(31, 41, 55, 1), width: 3))
              ),
            )
            ],
          )
